CREATE TABLE IF NOT EXISTS vialis.viajes
(
    id_tarjeta                 BIGINT,
    id_viaje                   SMALLINT,
...
-- Hexagono H3 --
CREATE TABLE IF NOT EXISTS vialis.hexagonos_viajes (
...
CREATE TABLE IF NOT EXISTS vialis.matriz_origen_destino (
...
CREATE TABLE IF NOT EXISTS vialis.tarifas_colectivo (
...
CREATE TABLE IF NOT EXISTS vialis.recorridos (
...
CREATE INDEX IF NOT EXISTS idx_paradas_posicion
ON vialis.paradas
USING GIST (posicion);
...
CREATE TABLE IF NOT EXISTS vialis.recorridos_paradas (
...
CREATE INDEX IF NOT EXISTS idx_recorridos_paradas_id_parada
